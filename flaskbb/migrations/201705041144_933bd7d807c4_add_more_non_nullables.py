...
def upgrade():
    ...
    with op.batch_alter_table("topics", schema=None) as batch_op:
        ...
        batch_op.alter_column("important", existing_type=sa.BOOLEAN(), nullable=False)
        batch_op.alter_column(
            "last_updated",
            existing_type=flaskbb.utils.database.UTCDateTime(timezone=True),
            nullable=False,
        )
        batch_op.alter_column("locked", existing_type=sa.BOOLEAN(), nullable=False)
        batch_op.alter_column("post_count", existing_type=sa.INTEGER(), nullable=False)
        batch_op.alter_column("views", existing_type=sa.INTEGER(), nullable=False)
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.alter_column("activated", existing_type=sa.BOOLEAN(), nullable=False)
        batch_op.alter_column(
            "date_joined",
            existing_type=flaskbb.utils.database.UTCDateTime(timezone=True),
            nullable=False,
        )
        batch_op.alter_column("login_attempts", existing_type=sa.INTEGER(), nullable=False)
...
def downgrade():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.alter_column("login_attempts", existing_type=sa.INTEGER(), nullable=True)
        batch_op.alter_column(
            "date_joined",
            existing_type=flaskbb.utils.database.UTCDateTime(timezone=True),
            nullable=True,
        )
        batch_op.alter_column("activated", existing_type=sa.BOOLEAN(), nullable=True)
    ...
    with op.batch_alter_table("topics", schema=None) as batch_op:
        batch_op.alter_column("views", existing_type=sa.INTEGER(), nullable=True)
        batch_op.alter_column("post_count", existing_type=sa.INTEGER(), nullable=True)
        batch_op.alter_column("locked", existing_type=sa.BOOLEAN(), nullable=True)
        batch_op.alter_column(
            "last_updated",
            existing_type=flaskbb.utils.database.UTCDateTime(timezone=True),
            nullable=True,
        )
        batch_op.alter_column("important", existing_type=sa.BOOLEAN(), nullable=True)
        batch_op.alter_column(
            "date_created",
            existing_type=flaskbb.utils.database.UTCDateTime(timezone=True),
            nullable=True,
