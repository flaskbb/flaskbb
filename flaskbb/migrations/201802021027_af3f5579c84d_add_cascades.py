...
def upgrade():
    ...
    with op.batch_alter_table("conversations", schema=None) as batch_op:
        if con.engine.dialect.name == "mysql":
            ...
            batch_op.drop_constraint(
                "conversations_to_user_id_fkey", type_="foreignkey"
            )
            batch_op.drop_constraint(
                "conversations_from_user_id_fkey", type_="foreignkey"
            )
    ...
    with op.batch_alter_table("forums", schema=None) as batch_op:
        if con.engine.dialect.name == "mysql":
            ...
            batch_op.drop_constraint(
                "forums_last_post_user_id_fkey", type_="foreignkey"
            )
    ...
    with op.batch_alter_table("messages", schema=None) as batch_op:
        ...
        if con.engine.dialect.name == "mysql":
            ...
            batch_op.drop_constraint(
                "messages_conversation_id_fkey", type_="foreignkey"
            )
...
def downgrade():
    ...
    with op.batch_alter_table("topictracker", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_topictracker_user_id_users"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_topictracker_topic_id_topics"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_topictracker_user_id_users", "users", ["user_id"], ["id"]
        )

    with op.batch_alter_table("topicsread", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_topicsread_user_id_users"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_topicsread_forum_id_forums"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_topicsread_topic_id_topics"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_topicsread_user_id_users", "users", ["user_id"], ["id"]
        )

    with op.batch_alter_table("topics", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_topics_forum_id_forums"), type_="foreignkey"
        )
    ...
    with op.batch_alter_table("posts", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_posts_topic_id_topics"), type_="foreignkey"
        )
    ...
    with op.batch_alter_table("moderators", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_moderators_user_id_users"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_moderators_forum_id_forums"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_moderators_user_id_users", "users", ["user_id"], ["id"]
        )
    ...
    with op.batch_alter_table("messages", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_messages_user_id_users", "users", ["user_id"], ["id"]
        )
        batch_op.create_foreign_key(
    ...
    with op.batch_alter_table("groups_users", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_groups_users_group_id_groups"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_groups_users_user_id_users"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_groups_users_user_id_users", "users", ["user_id"], ["id"]
        )
        batch_op.create_foreign_key(
    ...
    with op.batch_alter_table("forumsread", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_forumsread_user_id_users"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_forumsread_forum_id_forums"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_forumsread_user_id_users", "users", ["user_id"], ["id"]
        )
    ...
    with op.batch_alter_table("forums", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            batch_op.f("fk_forums_category_id_categories"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
    ...
    with op.batch_alter_table("forumgroups", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_forumgroups_forum_id_forums"), type_="foreignkey"
        )
        batch_op.drop_constraint(
            batch_op.f("fk_forumgroups_group_id_groups"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
    ...
    with op.batch_alter_table("conversations", schema=None) as batch_op:
        batch_op.drop_constraint(
            batch_op.f("fk_conversations_user_id_users"), type_="foreignkey"
        )
        batch_op.create_foreign_key(
