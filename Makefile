...
dev-plugins: ## Install the plugins as editable
	uv pip install -e ../flaskbb-plugin-portal -e ../flaskbb-plugin-conversations -e ../flaskbb-plugin-like -e ../flaskbb-plugin-vote -e ../flaskbb-plugin-ranks -e -e ../flaskbb-plugin-test-mail
